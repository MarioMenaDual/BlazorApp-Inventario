   ...
   public class InventaryContext: DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder options)
        {
            ...
            {
                options.UseSqlServer("Server=DESKTOP-T7RP0EK; Database=InventoryDb; User Id=sa; Password=root");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<WarehouseEntity>().HasData(
                ...
                new WarehouseEntity { WarehouseId = Guid.NewGuid().ToString(), 
                    WarehouseName = "Bodega Norte", WarehouseAddress = "Calle norte con occidente" }
                );
